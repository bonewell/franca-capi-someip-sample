...
int main() {
    ...
    std::string instance = "com.ford.rnd";
    ...
    bool ret_buttons = runtime->registerService(domain, instance, Buttons);
    if (ret_buttons) {
    ...
    bool ret_sml = runtime->registerService(domain, instance, mySService);
    if (ret_sml) {
